import aboutPortrait from '../../assets/images/home-portrait-avatar.webp';
import './About.scss'
function About() {
    return (
        <div className="about-main">
            ...
            <section className="section-presentation">
                <img src={aboutPortrait} alt='portrait de Yoann' className="hero-img" fetchPriority="high" />
            ...
            <section className="section-parcours">
                ...
                <div className='section-parcours_content'>
                    <h3 className='section-parcours_content_subtitle'>Éducateur canin : 2015 – 2022</h3>
                ...
                <div className='section-parcours_content'>
                    <h3 className='section-parcours_content_subtitle'>Agent de police municipale : depuis 2022</h3>
                ...
                <div className='section-parcours_content'>
                    <h3 className='section-parcours_content_subtitle'>Développeur web — OpenClassrooms : Reconversion</h3>
