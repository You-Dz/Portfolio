...
export const dataProjects = [
    ...
    // ============================================================
    {
        ...
        excerpt: "Intégration responsive multi-device d'un site d'hébergement touristique",
        context:
    ...
    // ============================================================
    {
        ...
        date: "2026-03",
        cover: "/images/sophiebuel-1.webp",
        screenshot: "",
        thumbnail: "",
        techs: [
            { name: "HTML", icon: "html5" },
        ...
        excerpt: "Portfolio interactif avec galerie dynamique et back-office administrateur",
        context:
    ...
    // ============================================================
    {
        ...
        date: "2026-04",
        cover: "/images/ninacarducci-1.webp",
        screenshot: "",
        thumbnail: "",
        techs: [
            { name: "HTML", icon: "html5" },
        ...
        excerpt: "Audit et optimisation complète : performance, accessibilité et référencement naturel",
        context:
    ...
    // ============================================================
    {
        ...
        excerpt: "Application React complète de location de logements avec navigation multi-pages",
        context:
    ...
    // ============================================================
    {
        ...
        date: "2026-06",
        cover: "/images/monvieuxgrimoire-1.webp",
        screenshot: "",
        thumbnail: "",
        techs: [
        ...
        excerpt: "API REST back-end complète de notation de livres avec authentification sécurisée",
        context:
            "Premier projet back-end full-stack. Mon Vieux Grimoire est une plateforme web permettant aux utilisateurs de noter et评议 des livres. Développement complet de l'API REST côté serveur avec Node.js et Express, base de données MongoDB via Mongoose, gestion sécurisée des images (Multer + Sharp), et système d'authentification par JWT et bcrypt. Approche axée sur la sécurité, la validation des données et les bonnes pratiques Green Code pour le traitement d'images.",
        objectives: [
    ...
    // ============================================================
    {
        ...
        excerpt: "Gestion de projet complète : cadrage, specs techniques et gestion de l'équipe de dev",
        context:
        ...
        stacks: [
            ...
            "Stack dev decidida : React + Vercel (front), Node.js/Express + Render (back), MongoDB Atlas (base NoSQL)",
        ],
        skills: [
